...
class CountryTables extends React.Component {
    constructor(props) {
        ...
        let keys = (this.data)?[...new Set(this.data.map(obj=>obj[3]))]:0;
        if(keys.length>1) keys.unshift("All Countries");
        this.dropdownItems = (keys)?keys.map(status => {return {value: status, label: status}}):[{value:"no data",label:"no data"}];
        ...
        return (
                    <div className="row row-eq-height">
                        <div className="col-sm-8">
                            <Card>
                                <Row>
                                    <InputGroup className="no-border col-md-4 mr-auto mt-1 ml-1" >
                                        <InputGroupAddon addonType="append" style={css}>
                                                <InputGroupText style={css}>
                                        ...
                                        <Input 
                                            ...
                                            type="text" onChange={(e)=>this.searchChange(e)}
                                            />
                                    </InputGroup>
                                    <Select
                                        className="react-select primary col-md-4 ml-auto mt-1 mr-1"
                                ...
                                <ReactTable
                                    className = "card-stats -highlight"
