...
namespace Core.Interfaces
{
    public interface IRepository
    {
        ...
        Task<int> AddAll<T>(IEnumerable<T> entityList, string tableName) where T : BaseEntity, new();
        Task<string> Update<T>(T entity, string tableName) where T : BaseEntity, new();

        Task<IEnumerable<T>> GetAllQithoutPartition<T>(string tableName) where T : BaseEntity, new();
