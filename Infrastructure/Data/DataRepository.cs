...
namespace Infrastructure.Data
{
    ...
    {
        private readonly ITableStorageInstance _tableStorageInstance;
        private readonly Dictionary<string, CloudTable> tableList;
        private readonly Dictionary<string, CloudTable> backUpTableList;

        public DataRepository(ITableStorageInstance tableStorageInstance)
        {
            _tableStorageInstance = tableStorageInstance;

            tableList = _tableStorageInstance.GetAzureTableStorageInstance();
            backUpTableList = _tableStorageInstance.GetAzureTableStorageBackUpInstance();
        }
